...
final class NewsTableViewCell: UITableViewCell {
    ...
    // MARK: - Init
    // Using UITableViewCell as superclass, so override the initializer
    ...
    // Required initializer when conforming to NSCoding (which is not used here)
    ...
    private func setupConstraints() {
        // Adjust constraints to properly position the subviews
    ...
    // MARK: - Configuration
    // Public method to configure the cell with news data
